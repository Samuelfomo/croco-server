...
const CountryModel = sequelize.define('Country', {
    ...
    dialcode: {
        ...
        // unique: {
        //     name: 'UNIQUE-Country-dialcode',
        //     msg: 'The dialcode of Country must be unique'
        // },
        allowNull: false,
        comment: "dialcode"
    },
    fr: {
        ...
        //     msg: 'The fr of Country must be unique'
        // },
        allowNull: false,
        comment: "fr"
    },
    en: {
        type: DataTypes.STRING(128),
        // unique: {
        //     name: 'UNIQUE-Country-en',
        //     msg: 'The en of Country must be unique'
        // },
        allowNull: false,
        comment: "en"
    }
