...
class  Decoder {
    constructor(id = null, guid = null, device, identifier, location, subscriber, started, finished,
    ...
    static fromJson(json){
        return new Decoder(
            json.id, json.guid, json.device, json.identifier, json.location, json.subscriber,
