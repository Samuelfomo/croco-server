...
class Payement{
    constructor(id = null, guid = null, amount, account, isCredited, old_balance, status, payement_method, mobile, created) {
        this.id = id;
        this.guid = guid;
        this.amount = amount;
    ...
    static fromJson(json){
        return new Payement(json.id, json.guid, json.amount, json.account, json.isCredited, json.old_balance, json.status, json.payement_method, json.mobile, json.created)
    }
