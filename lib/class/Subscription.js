...
class  Subscription {
    constructor(id = null, guid = null, reference = null, self_service, duration, amount, formula_cost, options_cost, status, operation = null, decoder, formula, old_formula = null, options = null, user, comment = null, created) {
        this.id = id;
        this.guid = guid;
    ...
    static async fromJson(json) {
        ...
        return new Subscription(
            ...
            json.options_cost, statusResult, operationResult, decoderResult, formulaResult,
            oldFormulaResult, validOptions, userResponse, json.comment, json.created
        )
    }
    ...
    static async sender(decoder, formula, options, duration, gateway = 1963, pin , code) {
