            ...
            if (entry){
                ...
                if(amountResponse === false){
                   ...
                   await SubscriptionModel.update({
                    ...
                    // const newBalance = amountResponse.balance - ;
                    const payement = new Payement(null, null, entry.amount, amountResponse.id, false, amountResponse.balance, null, "CGA", null, null);
                    const payementResponse = await payement.save()
