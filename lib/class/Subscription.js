...
class  Subscription {
    ...
    static async fromJson(json) {
        ...
        return new Subscription(
            ...
            json.options_cost, statusResult, operationResult, decoderResult, formulaResponse,
            oldFormulaResponse, validOptions, userResponse, json.comment, json.created
        )
    }
    ...
    static async sender(decoder, formula, options, duration) {
