...
class  Subscription {
    constructor(id = null, guid = null, reference = null, self_service, duration, amount, formula_cost, options_cost, status, operation = null, decoder, subscriber, formula, old_formula = null, options = null, user, comment = null, created) {
        this.id = id;
        this.guid = guid;
